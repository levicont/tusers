...
public class FileUploadController implements R {
	...
	private static final Resource resource = new ClassPathResource("/META-INF/img/AccessDenied.jpg");
	@Autowired
	...
	private String uploadFile(Model uiModel, HttpServletRequest request,
	...
	private byte[] getImageSource(@PathVariable("id") Long imgId, HttpServletResponse response)
		...
		if (image != null && image.getSource() != null) {
			...
			if (isValidUserForGallery(image.getGallery()))
